...
{% include expandable-code.html title="Solution" id="sol-1" file="code/week-07-08/solution-01.c" %}
...
{% include expandable-code.html title="Solution" id="sol-2" file="code/week-07-08/solution-02.c" %}
...
{% include expandable-code.html title="Solution" id="sol-3" file="code/week-07-08/solution-03.c" %}
...
{% include expandable-code.html title="Solution" id="sol-4" file="code/week-07-08/solution-04.c" %}
...
{% include expandable-code.html title="Solution" id="sol-5" file="code/week-07-08/solution-05.c" %}
...
{% include expandable-code.html title="Solution" id="sol-6" file="code/week-07-08/solution-06.c" %}
...
{% include expandable-code.html title="Solution" id="sol-7" file="code/week-07-08/solution-07.c" %}
